...
public class StatusBarHeaderMachine {
	...
	private static final String STATUS_BAR_CUSTOM_HEADER = "custom_header";
		...
		void observe() {
			mContext.getContentResolver()
					.registerContentObserver(
							//Settings.System.getUriFor(Settings.System.STATUS_BAR_CUSTOM_HEADER), false, this, UserHandle.USER_ALL);
							Settings.System.getUriFor(STATUS_BAR_CUSTOM_HEADER), false, this);
		}
	...
	public void updateEnablement() {
		...
		final boolean customHeader = Settings.System.getInt(mContext.getContentResolver(),
	...
	private IStatusBarHeaderProvider getCurrentProvider() {
		...
		String currentProvider = Settings.System.getString(mContext.getContentResolver(),
