...
*
*/
public class NetworkTrafficBamz extends TextView {
     ...
     *  @hide
     */
    public NetworkTrafficBamz(Context context) {
        this(context, null);
    }
     ...
     *  @hide
     */
    public NetworkTrafficBamz(Context context, AttributeSet attrs) {
     ...
     *  @hide
     */
    public NetworkTrafficBamz(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void updateTrafficDrawable() {
        ...
        if (isSet(mState, MASK_UP + MASK_DOWN)) {
            ...
            Drawable mDrawable = mContext.getResources().getDrawable(intTrafficDrawable);
            //Drawable mDrawable = ContextCompat.getDrawable(mContext, intTrafficDrawable);
            mDrawable.setColorFilter(mColor, PorterDuff.Mode.MULTIPLY);
            if (mToggle == 0) {
