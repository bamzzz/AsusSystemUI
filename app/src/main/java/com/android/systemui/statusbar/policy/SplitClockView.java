...
public class SplitClockView extends LinearLayout {
	...
	protected void onFinishInflate() {
		...
		mTimeView = (TextClock) findViewById(ComotID.Get("time_view", "id"));
		mAmPmView = (TextClock) findViewById(ComotID.Get("am_pm_view", "id"));
	}
	...
	public void updatePatterns() {
		...
		String formatString = String.valueOf(DateFormat.getTimeFormat(getContext()));
